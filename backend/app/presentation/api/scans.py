"""Endpoints para consultar schemas de scans."""
import logging
...
from app.domain.models import Scan, DbTable, DbSchema
from app.domain.schemas import TableSchemaOut
...
def get_scan_schema(scan_id: int, db: Session = Depends(get_db)):
    # Retorna o schema completo do scan solicitado.
