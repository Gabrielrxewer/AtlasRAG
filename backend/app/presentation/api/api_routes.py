"""Endpoints de CRUD para rotas de API catalogadas."""
import logging
...
from app.domain.schemas import ApiRouteCreate, ApiRouteOut, ApiRouteAnnotationUpdate
...
def update_route_annotations(route_id: int, payload: ApiRouteAnnotationUpdate, db: Session = Depends(get_db)):
    # Atualiza anotações e campos da rota.
