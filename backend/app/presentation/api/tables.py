"""Endpoints para amostras e anotações de tabelas."""
import logging
...
from app.domain.models import DbTable, DbColumn, Sample
from app.domain.schemas import SampleOut, AnnotationUpdate
...
def get_samples(table_id: int, db: Session = Depends(get_db)):
    # Retorna amostras de linhas de uma tabela.
