"""Utilitários de criptografia para segredos da aplicação."""
import base64
...
class EncryptionError(RuntimeError):
    """Erro específico de criptografia para inputs inválidos."""
    pass


def _decode_secret_bytes(raw: bytes) -> str:
    """Decodifica bytes resiliente a diferentes encodings."""
    try:
...
def _get_fernet() -> Fernet:
    """Carrega e valida a chave de criptografia."""
...
def encrypt_secret(value: str) -> str:
    """Criptografa o segredo usando Fernet."""
    fernet = _get_fernet()
...
def decrypt_secret(value: str) -> str:
    """Descriptografa o segredo e valida token."""
    fernet = _get_fernet()
    if not value:
        return ""
    try:
