// Página de cadastro e gerenciamento de rotas de API.
import { Box, Button, Card, CardContent, Grid, Stack, TextField, Typography } from "@mui/material";
import { useForm } from "react-hook-form";
import { z } from "zod";
import { zodResolver } from "@hookform/resolvers/zod";
import { useApiRoutes, useCreateApiRoute, useDeleteApiRoute } from "../../application/controllers/useApiRoutes";
...
const ApiRoutesPage = () => {
  ...
  const onSubmit = (values: FormValues) => {
    // Envia formulário e reseta campos.
