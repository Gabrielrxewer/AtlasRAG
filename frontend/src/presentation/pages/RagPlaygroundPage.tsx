// Página de testes RAG e reindexação.
import {
  Box,
  Button,
  Card,
...
import { useAskRag, useReindexRag } from "../../application/controllers/useRag";
import { useConnections } from "../../application/controllers/useConnections";
import { useApiRoutes } from "../../application/controllers/useApiRoutes";
...
const RagPlaygroundPage = () => {
  ...
  const handleAsk = () => {
    // Envia pergunta com escopo selecionado.
    askMutation.mutate({
      question,
      scope: {
